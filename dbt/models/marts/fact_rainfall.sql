SELECT
    ...
    CASE
        WHEN r.rn_10m = 0 OR r.rn_10m IS NULL THEN 'none'
        WHEN r.rn_10m > 0 AND r.rn_10m <= 1 THEN 'light'
        WHEN r.rn_10m > 1 AND r.rn_10m <= 5 THEN 'moderate'
        WHEN r.rn_10m > 5 THEN 'heavy'
